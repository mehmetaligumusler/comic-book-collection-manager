...
public class EventTest {
  ...
  public void testToString() {
      ...
      Event event = new Event(1, "Sample Event", "Sample content", "Sample user");

      // Expected string representation of the Event object
      ...
      // Call the toString() method of the Event object
